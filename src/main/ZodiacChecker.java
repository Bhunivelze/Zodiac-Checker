...
public class ZodiacChecker extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        ariesPic = new Image("main/aries.png");
        taurusPic = new Image("main/taurus.png");
        geminiPic = new Image("main/gemini.png");
        cancerPic = new Image("main/cancer.png");
        leoPic = new Image("main/leo.png");
        virgoPic = new Image("main/virgo.png");
        libraPic = new Image("main/libra.png");
        scorpioPic = new Image("main/scorpio.png");
        sagittariusPic = new Image("main/sagittarius.png");
        capricornPic = new Image("main/capricorn.png");
        aquariusPic = new Image("main/aquarius.png");
        piscesPic = new Image("main/pisces.png");
